		...
		<tbody>
			...
			<tr id="general-settings">
				<td colspan="2" style="padding:0;">
					...
					<p class="description"><?php _e( 'Manage options for ticket synchronization and mail sending.', 'woo_ts' ); ?></p>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					<p class="description"><?php _e( 'Only the tickets related to the designated event will be synced.', 'woo_ts' ); ?>.</p>
				</td>
			</tr>

			<tr>
				<th>
					<label for="api_userid"><?php _e( 'API E-mail', 'woo_ts' ); ?></label>
				</th>
				<td>
					<input type="text" size="30" id="api_userid" name="api_userid" value="<?php print ( esc_attr( $api_userid ) ); ?>" class="text" />
					<p class="description"><?php _e( 'The email ID used when registered with TicketSonic.', 'woo_ts' ); ?>.</p>
				</td>
			</tr>
			<tr>
				<th>
					<label for="api_key"><?php _e( 'API Key', 'woo_ts' ); ?></label>
				</th>
				<td>
					<input type="text" size="30" id="api_key" name="api_key" value="<?php print ( esc_attr( $api_key ) ); ?>" class="text" />
					<p class="description"><?php _e( 'The API Key that was issued to you after registration.', 'woo_ts' ); ?>.</p>
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					...
					<p class="description"><?php _e( 'E-mail Subject of the sent email with tickets. The tokens [ticket_number], [ticket_title], [ticket_description] and [ticket_price] could be used as replacement patterns.', 'woo_ts' ); ?>.</p>
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					...
					<p class="description"><?php _e( 'An html template for the body of the email containing the tickets. The tokens [ticket_number], [ticket_qr], [ticket_title], [ticket_description] and [ticket_price] could be used as replacement patterns.', 'woo_ts' ); ?>.</p>
				</td>
			</tr>

			<tr id="general-settings">
				<td colspan="2" style="padding:0;">
					<h3><div class="dashicons dashicons-admin-settings"></div>&nbsp;<?php _e( 'Endpoints Settings', 'woo_ts' ); ?></h3>
					<p class="description"><?php _e( 'Urls of the endpoints for communicating with TicketSonic. Unless there is an update of the API there is no need for changes in this section.', 'woo_ts' ); ?></p>
				</td>
			</tr>
